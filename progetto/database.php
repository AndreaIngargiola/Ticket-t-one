            ...
            switch($mode){
                ...
                case "artista":
                    ...
                    $stmt = $this->db->prepare("SELECT * 
                                                FROM(   SELECT  e.*, t.pathQuadrata 
                                                        FROM artista a, evento e, hosting h, tour t 
                                                        WHERE a.nickname LIKE ? AND e.nomeTour = t.nome AND h.nicknameArtista = a.nickname AND h.nomeTour = t.nome
                    
                    
                                                        UNION
                                                        
                                                        SELECT  e.*, t.pathQuadrata 
                                                        FROM artista a, evento e, featuring f, tour t 
                                                        WHERE a.nickname LIKE ? AND e.nomeTour = t.nome AND f.nickname = a.nickname AND f.idEvento = e.idEvento)e
                                                ORDER BY e.dataCreazione DESC");
