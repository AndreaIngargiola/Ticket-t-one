...
<div id= "idHeader" class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse flex-column align-items-end ml-lg-2 ml-0 " id="navbarCollapse">
                        <div class="navbar-nav flex-row  align-items-center">
                            ...
                            ?>
                                <a class="ex4" href="account.php"><span class="p1 fa-stack fa-2x has-badge"><i class="p3 fa fa-user fa-stack-1x " aria-hidden="true"></i></span></a>
    ...
    <main>
        <div class="alert alert-success alert-dismissible" id="nelCarrello" style="display:none;">
